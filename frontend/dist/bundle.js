...
/***/ function(module, exports, __webpack_require__) {
	...
	var Issue = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var id = _props$value.id;
	    var title = _props$value.title;
	    var url = _props$value.url;
	    var number = _props$value.number;
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { href: 'https://github.com/facebook/react-native/issues/' + number, target: '_blank' },
	        title
	      )
	    );
	  } });
	...
	var App = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    request.get('http://react-native-issues-api.herokuapp.com').end(function (err, result) {
	      if (!err) {
	        _this.setState({ issues: result.body });
	      } else {
	    ...
	    if (this.state.issues) {
	      return React.createElement(
	        ...
	        this.state.issues.map(function (i) {
	          return React.createElement(Issue, { value: i });
	        })
	      );
	    } else {
	      return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(159);
